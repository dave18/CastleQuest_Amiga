...
void sayit(char * sb)
{
    ...
    VoiceIO->message.io_Data = sb;
    VoiceIO->message.io_Length=strlen(sb);
    VoiceIO->rate = 160;
    DoIO(VoiceIO);
}

void printstring(outstring *a)
{
    char newline[3]={0x20,0x20,0x0A};
    char * sPtr;;
    strcpy(scanbuf,a->cifmt);

    //**** First check for the sequence (\0020 ****
    sPtr=strstr(scanbuf,"(\0020");
    if (sPtr) {
      //printf("Sequence (0020 found %x %x %x %x %x \n",scanbuf[0],scanbuf[1],scanbuf[2],scanbuf[3],scanbuf[4]);
      strncpy(sPtr,newline,3);
    }

    //**** Next check for the sequence ('0 ****
    sPtr=strstr(scanbuf,"('0");
    if (sPtr) {
      //printf("Sequence ('0 found \n");
      strncpy(sPtr,newline,3);
    }
    ...
    if (sPtr) {
      ...
      //strncpy(sPtr,"  ",2);
      memmove(scanbuf,scanbuf+2,strlen(scanbuf)-1);
    }
   ...
   if (scanbuf[0]==0x28) {
       memmove(scanbuf,scanbuf+1,strlen(scanbuf));
   }

   //printf("Final char %x \n",scanbuf[strlen(scanbuf)-1]);

   if (scanbuf[strlen(scanbuf)-1]==0x29) {
       scanbuf[strlen(scanbuf)-1]=0;
   }

   /*Finally fix any occurrences of '' */
   sPtr=strstr(scanbuf,"''");
    if (sPtr) {
      printf("Sequence '' found \n");
      //strncpy(sPtr,"  ",2);
      memmove(sPtr,sPtr+1,strlen(scanbuf));
   }
    ...
    //printf(speakbuf);
    if (willspeak) sayit(speakbuf);
}


/*integer s_wsfe(outstring *a)
{
    printstring(a);
    return 0;
}
...
double rdm_(real* seed)
{
  int r;
  r=rand() % 1000;
  return (double)r/(double)1000.0;
}
...
acco, and\002,/,\002   crashes through the door in search of water.\002)";
    ...
    static char fmt_9998[] = "(\002\n  You made \002,i4,\002 moves, and score\
...
tial flood,\002,/,\002   and swallows you in a sea of icy cold water.\002)";
    ...
    static char fmt_9997[] = "(\002\n  You scored \002,i4,\002 out of \002,\
i4,\002 points.\002)";
...
effort.\n\002)";
 ...
 game.\n\002)";
    static char fmt_7005[] = "(\0020  You are a GREENHORN at this game!!\n\002)"
        ;
    static char fmt_7006[] = "(\0020  You don't deserve to WALK THE EARTH!\
!\n\002)";

    static char fmt_MUTE[] = "(\0020  Speech turned off.\n\002)";

    static char fmt_TALK[] = "(\0020  Speech turned on.\n\002)";
...
#define mas4 ((logical *)&block2_1 + 214)
    ...
    static cilist io___236 = { 0, 6, 0, fmt_1073, 0 };
    static cilist io___237 = { 0, 6, 0, fmt_1002, 0 };
    static cilist io___238 = { 0, 6, 0, fmt_1037, 0 };
    static cilist io___239 = { 0, 6, 0, fmt_1064, 0 };
    static cilist io___240 = { 0, 6, 0, fmt_1038, 0 };
    static cilist io___241 = { 0, 6, 0, fmt_1004, 0 };
    static cilist io___242 = { 0, 6, 0, fmt_1016, 0 };
    static cilist io___243 = { 0, 6, 0, fmt_1005, 0 };
    static cilist io___244 = { 0, 6, 0, fmt_1096, 0 };
    static cilist io___245 = { 0, 6, 0, fmt_1107, 0 };
    static cilist io___246 = { 0, 6, 0, fmt_1133, 0 };
    static cilist io___247 = { 0, 6, 0, fmt_1136, 0 };
    static cilist io___248 = { 0, 6, 0, fmt_1144, 0 };
    static cilist io___250 = { 0, 6, 0, fmt_1109, 0 };
    static cilist io___251 = { 0, 6, 0, fmt_1108, 0 };
    static cilist io___252 = { 0, 6, 0, fmt_1108, 0 };
    static cilist io___253 = { 0, 6, 0, fmt_1008, 0 };
    static cilist io___254 = { 0, 6, 0, fmt_9998, 0 };
    static cilist io___255 = { 0, 6, 0, fmt_9997, 0 };
    static cilist io___256 = { 0, 6, 0, fmt_7001, 0 };
    static cilist io___258 = { 0, 6, 0, fmt_7002, 0 };
    static cilist io___260 = { 0, 6, 0, fmt_7003, 0 };
    static cilist io___261 = { 0, 6, 0, fmt_7004, 0 };
    static cilist io___262 = { 0, 6, 0, fmt_7005, 0 };
    static cilist io___263 = { 0, 6, 0, fmt_7006, 0 };
    static cilist io___264 = { 0, 6, 0, fmt_MUTE, 0 };
    static cilist io___265 = { 0, 6, 0, fmt_TALK, 0 };
...
/* Open Narrator Device */
    ...
    if (VoiceMP=CreateMsgPort())
    {
        if (VoiceIO=CreateIORequest(VoiceMP,sizeof(struct narrator_rb)))
        {
            ...
            {
                printf("Could not open narrator.device - speech disabled \n");
                canspeak=0;
                willspeak=0;
            }
            else
...
/* L203: */
    ...
    //s_wsfe(&io___111);
    //e_wsfe();
        printstring(&io___111);
    }
    if (*but == 4) {
    //s_wsfe(&io___112);
    //e_wsfe();
        printstring(&io___112);
    }
L766:
    if (*object == 46) {
    //s_wsfe(&io___113);
    //e_wsfe();
        printstring(&io___113);
    }
    if (*object == 52) {
    //s_wsfe(&io___114);
    //e_wsfe();
        printstring(&io___114);
    }
    if (*object == 8) {
    //s_wsfe(&io___115);
    //e_wsfe();
        printstring(&io___115);
    }
...
L216:
    //s_wsfe(&io___118);
    //e_wsfe();
    printstring(&io___118);
    goto L25;
L218:
    //s_wsfe(&io___119);
    //e_wsfe();
    printstring(&io___119);
    goto L25;
...
L233:
    ...
    *wind2 = 3;
    //s_wsfe(&io___131);
    //e_wsfe();
    printstring(&io___131);
    goto L25;
L238:
    //s_wsfe(&io___132);
    //e_wsfe();
    printstring(&io___132);
    items[24] = 0;
    *max_ += -10;
    goto L25;
L240:
...
/*    ---FUCK--- */
    ...
    //s_wsfe(&io___139);
    //e_wsfe();
    printstring(&io___139);
    goto L25;
L261:
    //s_wsfe(&io___140);
    //e_wsfe();
    printstring(&io___140);
    goto L25;
L120:
/*     ---WAVE--- */
    if (items[*object - 1] != -1) {
...
L264:
    ...
    //s_wsfe(&io___146);
    //e_wsfe();
    printstring(&io___145);
    printstring(&io___146);
    *wiz = FALSE_;
    goto L25;
L263:
    if (*room != 43) {
...
L266:
    ...
    //s_wsfe(&io___150);
    //e_wsfe();
    printstring(&io___150);
    goto L25;
L246:
    //s_wsfe(&io___151);
    //e_wsfe();
    printstring(&io___151);
    goto L25;
L247:
    if (*master == 0) {
    goto L201;
...
/* L252: */
    ...
    s_wsfe(&io___155);
    e_wsfe();*/
    printstring(&io___153);
    printstring(&io___154);
    printstring(&io___155);
 
    goto L25;
L250:
    //s_wsfe(&io___156);
    //e_wsfe();
    printstring(&io___156);
    goto L25;
L122:
/*     ---FEED--- */
    if (*object != 55) {
...
L248:
    ...
    *blood = FALSE_;
    //s_wsfe(&io___158);
    //e_wsfe();
    printstring(&io___158);
    goto L25;
L249:
    //s_wsfe(&io___159);
    //e_wsfe();
    printstring(&io___159);
    goto L25;
L251:
    if (items[21] != -1) {
    goto L224;
...
L267:
    ...
    //s_wsfe(&io___163);
    //e_wsfe();
    printstring(&io___163);
    goto L25;
L224:
    //s_wsfe(&io___164);
    //e_wsfe();
    printstring(&io___164);
    goto L25;
L123:
/*     ---EAT--- */
    if (*object != 22) {
...
L383:
    ...
    s_wsfe(&io___172);
    e_wsfe();*/
    printstring(&io___171);
    printstring(&io___172);
...
/*     ---OPEN--- */
    ...
    *object = 47;
    ...
    //s_wsfe(&io___173);
    //e_wsfe();
        printstring(&io___173);
    }
L271:
    if (door[*room - 1] == 2) {
    //s_wsfe(&io___174);
    //e_wsfe();
        printstring(&io___174);
    }
    if (door[*room - 1] != 1) {
    goto L25;
    }
...
L393:
    //s_wsfe(&io___175);
    //e_wsfe();
    printstring(&io___175);
    goto L25;
L272:
    if (door[5] == 0) {
    //s_wsfe(&io___176);
    //e_wsfe();
        printstring(&io___176);
    }
    if (door[5] == 2) {
    //s_wsfe(&io___177);
    //e_wsfe();
        printstring(&io___177);
    }
    if (door[5] != 1) {
    goto L25;
    }
...
L273:
    //s_wsfe(&io___178);
    //e_wsfe();
    printstring(&io___178);
    goto L25;
L276:
    //s_wsfe(&io___179);
    //e_wsfe();
    printstring(&io___179);
    goto L25;
L275:
    if (*object != 38) {
    goto L277;
...
L280:
    ...
    //s_wsfe(&io___184);
    //e_wsfe();
    printstring(&io___184);
    goto L25;
L281:
    //s_wsfe(&io___185);
    //e_wsfe();
    printstring(&io___185);
    goto L25;
L282:
    if (*object != 40) {
    goto L285;
...
L477:
    ...
    *torch = TRUE_;
    //s_wsfe(&io___193);
    //e_wsfe();
    printstring(&io___193);
    goto L25;
L322:
    //s_wsfe(&io___194);
    //e_wsfe();
    printstring(&io___194);
    goto L25;
L476:
    if (items[26] != -3) {
    goto L700;
    ...
    s_wsfe(&io___196);
    e_wsfe();*/
    printstring(&io___195);
    printstring(&io___196);
    items[26] = 0;
    *hole = TRUE_;
    goto L25;
L133:
...
/*     ---BREAK--- */
    ...
    //s_wsfe(&io___200);
    //e_wsfe();
    printstring(&io___200);
    door[5] = 1;
    goto L25;
L297:
    //s_wsfe(&io___201);
    //e_wsfe();
    printstring(&io___201);
    yorn_(&ii);
    if (ii == 0) {
    goto L25;
    }
...
L309:
    ...
    //s_wsfe(&io___206);
    //e_wsfe();
    printstring(&io___206);
    goto L25;
L303:
    //s_wsfe(&io___207);
    //e_wsfe();
    printstring(&io___207);
    goto L25;
L138:
L139:
/*     ---POUR--- */
...
L398:
    ...
    //s_wsfe(&io___214);
    //e_wsfe();
        printstring(&io___214);
    }
    if (*room == 96 || *room == 98) {
    //s_wsfe(&io___215);
    //e_wsfe();
        printstring(&io___215);
    }
    *ndeath = 3;
    goto L902;
L146:
...
L314:
    //s_wsfe(&io___224);
    //e_wsfe();
    printstring(&io___224);
    goto L25;
L316:
    //s_wsfe(&io___225);
    //e_wsfe();
    printstring(&io___225);
    lock = 0;
    goto L25;
L154:
/*     ---SHOOT--- */
...
L484:
    ...
    //s_wsfe(&io___229);
    //e_wsfe();
    printstring(&io___229);
    items[1] = *room;
    goto L25;
L485:
    //s_wsfe(&io___230);
    //e_wsfe();
    printstring(&io___230);
    *gun = TRUE_;
    ++(*numb);
    goto L25;
L486:
    ...
    //s_wsfe(&io___231);
    //e_wsfe();
    printstring(&io___231);
    items[1] = 0;
    goto L25;
L487:
    //s_wsfe(&io___232);
    //e_wsfe();
    printstring(&io___232);
    items[1] = *room;
    ii = 1;
    wwolf_(&ii, wolf);
    if (ii == 0) {
...
/*     ---BRIEF--- */
    *ibrief = 1;
    //s_wsfe(&io___236);
    //e_wsfe();
    printstring(&io___236);
    goto L25;
L700:
    //s_wsfe(&io___237);
    //e_wsfe();
    printstring(&io___237);
    goto L25;
L710:
    //s_wsfe(&io___238);
    //e_wsfe();
    printstring(&io___238);
    if (*room > 40 && ((*lamp == 0 || *lamp == 3) && *match == 0)) {
    //s_wsfe(&io___239);
    //e_wsfe();
        printstring(&io___239);
    }
    goto L25;
L712:
    //s_wsfe(&io___240);
    //e_wsfe();
    printstring(&io___240);
    goto L25;
L720:
    //s_wsfe(&io___241);
    //e_wsfe();
    printstring(&io___241);
    goto L25;
L730:
    //s_wsfe(&io___242);
    //e_wsfe();
    printstring(&io___242);
    goto L25;
L740:
    //s_wsfe(&io___243);
    //e_wsfe();
    printstring(&io___243);
    goto L25;
L750:
    //s_wsfe(&io___244);
    //e_wsfe();
    printstring(&io___244);
    goto L25;
L760:
    //s_wsfe(&io___245);
    //e_wsfe();
    printstring(&io___245);
    goto L25;
L765:
    items[12] = 86;
    //s_wsfe(&io___246);
    //e_wsfe();
    printstring(&io___246);
    goto L902;
L767:
    *masect = TRUE_;
    //s_wsfe(&io___247);
    //e_wsfe();
    printstring(&io___247);
    goto L25;
L769:
    //s_wsfe(&io___248);
    //e_wsfe();
    printstring(&io___248);
    goto L902;
L770:
    if (action[0] == 54) {
    goto L775;
...
Lmute:
   willspeak=0;
   printstring(&io___264);
   goto L25;

Ltalk:
   if (canspeak) willspeak=1;
   printstring(&io___265);
   goto L25;
...
/*     ---END OF GAME (WINNER)--- */
    ...
    //s_wsfe(&io___258);
    //e_wsfe();
        printstring(&io___258);
    }
    l = k - jj;
    if (ii < k && ii >= l) {
    //s_wsfe(&io___260);
    //e_wsfe();
        printstring(&io___260);
    }
    k = l - jj;
    if (ii < l && ii >= k) {
    //s_wsfe(&io___261);
    //e_wsfe();
        printstring(&io___261);
    }
    l = k - jj;
    if (ii < k && ii >= l) {
    //s_wsfe(&io___262);
    //e_wsfe();
        printstring(&io___262);
    }
    if (ii < l) {
    //s_wsfe(&io___263);
    //e_wsfe();
        printstring(&io___263);
    }
L9900:
...
/* L9999: */
   ...
   /*Think this is exit routine so close narrator.device*/
   if (canspeak)
   {
